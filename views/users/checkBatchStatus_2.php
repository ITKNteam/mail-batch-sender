...
<div class="bs-callout bs-callout-danger">
    <h2>Задача поставлена в очередь на исполнение</h2>
    <h3>Вы можете закрыть эту страницу, и вернуться к ней позже</h3>
    <h4>Внимание!</h4>
    
    <p>На данной странице, вы можете проследить ход выполнения операции загрузки контактов в Unisender.
       Так как, существуют технологические ограничения, загрузка осуществляется пачками по 50 контактов в минуту.
...
<?= Html::a("Refresh", ["users/check-batch-status-2?batch_id=$batch_id&list_id=$list_id"], ['class' => 'btn btn-md btn-primary', 'id' => 'refreshButton']) ?>
